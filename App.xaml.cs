...
namespace lunagalLauncher
{
    ...
    public partial class App : Application
    {
        ...
        /// <summary>主窗口导航 Frame（供需要时访问）。</summary>
        ...
        public App()
        {
            ...
            try
            {
                ...
                {
                    LoggerManager.LogException(ev.Exception, "TaskScheduler.UnobservedTaskException");
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            try
            {
                ...
                // 导航框架 + 全窗格模态叠层（叠层与 Frame 同宽同高，卡片在叠层内 Horizontal/Vertical Center）
                if (window.Content is not Grid || RootFrame == null || WindowModalOverlay == null)
                {
                    ...
                    WindowModalOverlay = overlay;

                    var shell = new Grid();
                    shell.Children.Add(rootFrame);
        ...
        private void App_UnhandledException(object sender, Microsoft.UI.Xaml.UnhandledExceptionEventArgs e)
        {
            ...
            // 立即刷盘，避免随后 Xaml 核心直接终止进程导致日志丢失（Serilog 默认 Async sink 易丢尾部）
            try { Serilog.Log.CloseAndFlush(); } catch { }
